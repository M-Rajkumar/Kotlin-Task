...
import com.edu.mdu.kotlin_gis_task.helpers.InputValidation
...
class RegisterActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun postDataToSQLite() {
        ...
        if (!databaseHelper!!.checkUser(textInputEditTextEmail!!.text.toString().trim())) {
            ...
            val userNameStrTemp =textInputEditTextName!!.text.toString().trim()
            emailStr =textInputEditTextEmail!!.text.toString().trim()
            phoneStr =textInputEditTextPhone!!.text.toString().trim()
            passStr =textInputEditTextConfirmPassword!!.text.toString().trim()

            Log.d("fadfa", "value issss: $userNameStrTemp")
            val sharedPref: SharedPreferences = getSharedPreferences(PREF_NAME, PRIVATE_MODE)

            sharedPref.edit().apply {
                putString("regName",userNameStrTemp)
                putString("regEmail",emailStr)
                putString("regPhone",phoneStr)
                putString("regPass",passStr)
            }.apply()
            val mlastname = sharedPref.getString("regName","").toString();
            Log.d("daniel", "mlastname is: $mlastname")
...
//
//            editor.putString("regName",userNameStr)
//            editor.putString("regEmail",emailStr)
//            editor.putString("regPhone",phoneStr)
//            editor.putString("regPass",passStr)
//            editor.apply()
        } else {
